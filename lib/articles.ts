...
export const ARTICLES: Article[] = [
  {
    ...
    date: "Julho 2026",
    coverImage: "/images/banner-remanufatura-dexter.jpg",
  ...
  },
  {
    ...
    excerpt:
      "A Dexter Embreagens foi patrocinadora da primeira edição do Lendas Camp em 2024, uma imersão futebolística para jovens talentos ao lado de craques como Craque Neto, Velloso e Muller.",
    date: "2024",
    coverImage: "/images/lendas-camp-capa.jpg",
    coverPosition: "50% 25%",
    category: "Patrocínio",
    content: [
      "A Dexter Embreagens tem orgulho de ter sido uma das patrocinadoras da primeira etapa do Lendas Camp em 2024, um projeto social inovador que uniu jovens talentos a lendas do futebol brasileiro.",
  ...
  },
  {
    ...
    content: [
      ...
      "A segunda edição de 2024 foi ainda maior que a primeira, reunindo mais jovens atletas e trazendo novos craques do futebol brasileiro. Entre os participantes estiveram nomes como Souza, André Petroni, Alexandre Alves e Rogerinho R9, além dos já conhecidos Craque Neto e Velloso.",
